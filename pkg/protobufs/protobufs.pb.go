...
func (DatabaseRequest_WriteOptEnum) EnumDescriptor() ([]byte, []int) {
	return file_pkg_protobufs_protobufs_proto_rawDescGZIP(), []int{40, 0}
}
...
var file_pkg_protobufs_protobufs_proto_rawDesc = []byte{
	...
	0x22, 0xda, 0x02, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x71,
	...
	0x65, 0x73, 0x73, 0x12, 0x43, 0x0a, 0x08, 0x77, 0x72, 0x69, 0x74, 0x65, 0x4f, 0x70, 0x74, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x27, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	...
	,
	...
	0x22, 0x9d, 0x02, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	0x6e, 0x12, 0x38, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x22, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x73, 0x2e, 0x4c, 0x6f, 0x67,
	...
	0x42, 0x10, 0x5a, 0x0e, 0x71, 0x6c, 0x69, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
...
var file_pkg_protobufs_protobufs_proto_goTypes = []any{
	...
	(*DatabaseEntity)(nil),                                   // 47: protobufs.DatabaseEntity
	(*DatabaseField)(nil),                                    // 48: protobufs.DatabaseField
	(*DatabaseNotificationConfig)(nil),                       // 49: protobufs.DatabaseNotificationConfig
	(*DatabaseNotification)(nil),                             // 50: protobufs.DatabaseNotification
	(*DatabaseEntitySchema)(nil),                             // 51: protobufs.DatabaseEntitySchema
	(*DatabaseFieldSchema)(nil),                              // 52: protobufs.DatabaseFieldSchema
	(*DatabaseRequest)(nil),                                  // 53: protobufs.DatabaseRequest
	(*DatabaseSnapshot)(nil),                                 // 54: protobufs.DatabaseSnapshot
	(*Int)(nil),                                              // 55: protobufs.Int
	(*String)(nil),                                           // 56: protobufs.String
	(*Timestamp)(nil),                                        // 57: protobufs.Timestamp
	(*Float)(nil),                                            // 58: protobufs.Float
	(*Bool)(nil),                                             // 59: protobufs.Bool
	(*EntityReference)(nil),                                  // 60: protobufs.EntityReference
	(*BinaryFile)(nil),                                       // 61: protobufs.BinaryFile
	(*Transformation)(nil),                                   // 62: protobufs.Transformation
	(*LogMessage)(nil),                                       // 63: protobufs.LogMessage
	(*timestamppb.Timestamp)(nil),                            // 64: google.protobuf.Timestamp
	(*anypb.Any)(nil),                                        // 65: google.protobuf.Any
}
var file_pkg_protobufs_protobufs_proto_depIdxs = []int32{
	64, // 0: protobufs.WebHeader.timestamp:type_name -> google.protobuf.Timestamp
	...
	65, // 3: protobufs.WebMessage.payload:type_name -> google.protobuf.Any
	...
	47, // 7: protobufs.WebConfigGetEntityResponse.entity:type_name -> protobufs.DatabaseEntity
	4,  // 8: protobufs.WebConfigGetFieldSchemaResponse.status:type_name -> protobufs.WebConfigGetFieldSchemaResponse.StatusEnum
	52, // 9: protobufs.WebConfigGetFieldSchemaResponse.schema:type_name -> protobufs.DatabaseFieldSchema
	5,  // 10: protobufs.WebConfigGetEntitySchemaResponse.status:type_name -> protobufs.WebConfigGetEntitySchemaResponse.StatusEnum
	51, // 11: protobufs.WebConfigGetEntitySchemaResponse.schema:type_name -> protobufs.DatabaseEntitySchema
	51, // 12: protobufs.WebConfigSetEntitySchemaRequest.schema:type_name -> protobufs.DatabaseEntitySchema
	...
	54, // 15: protobufs.WebConfigCreateSnapshotResponse.snapshot:type_name -> protobufs.DatabaseSnapshot
	54, // 16: protobufs.WebConfigRestoreSnapshotRequest.snapshot:type_name -> protobufs.DatabaseSnapshot
	...
	53, // 19: protobufs.WebRuntimeDatabaseRequest.requests:type_name -> protobufs.DatabaseRequest
	53, // 20: protobufs.WebRuntimeDatabaseResponse.response:type_name -> protobufs.DatabaseRequest
	49, // 21: protobufs.WebRuntimeRegisterNotificationRequest.requests:type_name -> protobufs.DatabaseNotificationConfig
	50, // 22: protobufs.WebRuntimeGetNotificationsResponse.notifications:type_name -> protobufs.DatabaseNotification
	...
	47, // 24: protobufs.WebRuntimeGetEntitiesResponse.entities:type_name -> protobufs.DatabaseEntity
	60, // 25: protobufs.DatabaseEntity.parent:type_name -> protobufs.EntityReference
	60, // 26: protobufs.DatabaseEntity.children:type_name -> protobufs.EntityReference
	65, // 27: protobufs.DatabaseField.value:type_name -> google.protobuf.Any
	64, // 28: protobufs.DatabaseField.writeTime:type_name -> google.protobuf.Timestamp
	48, // 29: protobufs.DatabaseNotification.current:type_name -> protobufs.DatabaseField
	48, // 30: protobufs.DatabaseNotification.previous:type_name -> protobufs.DatabaseField
	48, // 31: protobufs.DatabaseNotification.context:type_name -> protobufs.DatabaseField
	52, // 32: protobufs.DatabaseEntitySchema.fields:type_name -> protobufs.DatabaseFieldSchema
	65, // 33: protobufs.DatabaseRequest.value:type_name -> google.protobuf.Any
	57, // 34: protobufs.DatabaseRequest.writeTime:type_name -> protobufs.Timestamp
	56, // 35: protobufs.DatabaseRequest.writerId:type_name -> protobufs.String
	11, // 36: protobufs.DatabaseRequest.writeOpt:type_name -> protobufs.DatabaseRequest.WriteOptEnum
	47, // 37: protobufs.DatabaseSnapshot.entities:type_name -> protobufs.DatabaseEntity
	48, // 38: protobufs.DatabaseSnapshot.fields:type_name -> protobufs.DatabaseField
	51, // 39: protobufs.DatabaseSnapshot.entitySchemas:type_name -> protobufs.DatabaseEntitySchema
	64, // 40: protobufs.Timestamp.raw:type_name -> google.protobuf.Timestamp
	12, // 41: protobufs.LogMessage.level:type_name -> protobufs.LogMessage.LogLevelEnum
	64, // 42: protobufs.LogMessage.timestamp:type_name -> google.protobuf.Timestamp
