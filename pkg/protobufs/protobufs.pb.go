...
var file_pkg_protobufs_protobufs_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_pkg_protobufs_protobufs_proto_goTypes = []any{
	...
	(*Choice)(nil),                                           // 63: protobufs.Choice
	(*EntityList)(nil),                                       // 64: protobufs.EntityList
	(*LogMessage)(nil),                                       // 65: protobufs.LogMessage
	(*timestamppb.Timestamp)(nil),                            // 66: google.protobuf.Timestamp
	(*anypb.Any)(nil),                                        // 67: google.protobuf.Any
}
var file_pkg_protobufs_protobufs_proto_depIdxs = []int32{
	66, // 0: protobufs.ApiHeader.timestamp:type_name -> google.protobuf.Timestamp
	12, // 1: protobufs.ApiMessage.header:type_name -> protobufs.ApiHeader
	67, // 2: protobufs.ApiMessage.payload:type_name -> google.protobuf.Any
	...
	67, // 23: protobufs.DatabaseField.value:type_name -> google.protobuf.Any
	66, // 24: protobufs.DatabaseField.writeTime:type_name -> google.protobuf.Timestamp
	49, // 25: protobufs.DatabaseNotification.current:type_name -> protobufs.DatabaseField
	49, // 26: protobufs.DatabaseNotification.previous:type_name -> protobufs.DatabaseField
	49, // 27: protobufs.DatabaseNotification.context:type_name -> protobufs.DatabaseField
	53, // 28: protobufs.DatabaseEntitySchema.fields:type_name -> protobufs.DatabaseFieldSchema
	67, // 29: protobufs.DatabaseRequest.value:type_name -> google.protobuf.Any
	58, // 30: protobufs.DatabaseRequest.writeTime:type_name -> protobufs.Timestamp
	57, // 31: protobufs.DatabaseRequest.writerId:type_name -> protobufs.String
	10, // 32: protobufs.DatabaseRequest.writeOpt:type_name -> protobufs.DatabaseRequest.WriteOptEnum
	48, // 33: protobufs.DatabaseSnapshot.entities:type_name -> protobufs.DatabaseEntity
	49, // 34: protobufs.DatabaseSnapshot.fields:type_name -> protobufs.DatabaseField
	52, // 35: protobufs.DatabaseSnapshot.entitySchemas:type_name -> protobufs.DatabaseEntitySchema
	66, // 36: protobufs.Timestamp.raw:type_name -> google.protobuf.Timestamp
	11, // 37: protobufs.LogMessage.level:type_name -> protobufs.LogMessage.LogLevelEnum
	66, // 38: protobufs.LogMessage.timestamp:type_name -> google.protobuf.Timestamp
